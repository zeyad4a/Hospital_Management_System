            ...
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <table class=" table table-striped table-hover table-bordered border-gray-400">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <?php
                        $docid = $_SESSION['id'];
                        $sql = mysqli_query($connect, "SELECT * from appointment join users on users.uid=appointment.userId  join doctors on doctors.id=appointment. doctorId where doctorId='$docid' AND appointmentDate = CURRENT_DATE() AND userStatus in ( 1 , 2 ) ORDER BY postingDate DESC ");
                                ...
                                <th scope="col">
                                    <form method="get">
                                        ...
                                        <?php
                                            ...
                                            <p class="text-lg leading- font-bold text-gray-900 text-center"><a href="./doc-write.php?id=<?php echo $row['apid']; ?>&uid=<?php echo $row['userId']; ?>" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-green-700 ring-1 ring-inset ring-green-600/20">View</a></p>
