                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./doc.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Doctors Time Table</a>
                            </div>
                        </div>
                    </div>
...
<tbody class="table-group-divider">
    ...
    <?php
    $docid = $_SESSION['id'];
    $sql = mysqli_query($connect, "select * from appointment join users on users.id=appointment.userId where doctorId='$docid' AND 	appointmentDate = CURRENT_DATE() AND userStatus = 1 ");
    while ($row = mysqli_fetch_array($sql)) {
    ?>
        <tr>
            <th scope="col">
            ...
            <th scope="col">
                <form method="get">
                    ...
                    <?php
                        ...
                        <p class="text-lg leading- font-bold text-gray-900 text-center"><a href="./doc-write.php?id=<?php echo $row['id']; ?>" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-green-700 ring-1 ring-inset ring-green-600/20">View</a></p>
