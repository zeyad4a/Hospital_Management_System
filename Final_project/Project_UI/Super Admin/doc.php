...
if (isset($_GET['cancel'])) {
    mysqli_query($connect, "DELETE FROM doctors where id = " . $_GET['id'] . "");
    echo "<script>alert('doctor Deleted Successful');</script>";
  }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Doctors Statue</h1>
            </div>
        </header>
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <form class="space-y-6 flex flex-wrap p-3" action="./search-doc.php" method="POST">
                    ...
                    <div class="px-3 py-1.5">
                        <button name="search" type="submit" class="flex w-20 justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
                    </div>
                </form>
                <table class=" table table-striped table-hover table-bordered border-gray-400 w-full">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Delete Doctor</p>
                            </th>
                        </tr>
                    </thead>
                    <tbody class="table-group-divider">
                        ...
                        ?>
                            <tr>
                                ...
                                <th scope="col">
                                    <p class=" text-lg leading- font-bold text-gray-900 text-center">
                                <a href="./doc.php?id=<?php echo $row['id'] ?>&cancel=update" onClick="return confirm('Are You Sure You Want To Delete ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> Delete </a>
                                </p>
                            </th>
                            </tr>
                    </tbody>
