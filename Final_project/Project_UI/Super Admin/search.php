                ...
                <div class="flex flex-wrap w-full">
                    ...
                    <table class=" table table-striped table-hover table-bordered border-gray-400">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <?php
                            $search = $_POST['input'];
                            $ret = mysqli_query($connect, "SELECT * FROM `appointment` WHERE `patient_Name` LIKE '%$search%' OR `patient_Num` LIKE '%$search%' OR `userId` LIKE '%$search%' ORDER BY postingDate DESC");
                            if ($ret->num_rows > 0) {
