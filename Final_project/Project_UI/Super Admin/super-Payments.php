        ...
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <div class=" flex flex-wrap w-2/4">
                    ...
                    <form class="space-y-6 flex flex-wrap p-3" action="./search-pay.php" method="POST">
                ...
                <table class=" table table-striped table-hover table-bordered border-gray-400 ">
                    <?php
                    $id = $_GET['employId'];
                    $sqlp = "SELECT SUM(consultancyFees) AS total FROM appointment WHERE `employId` = '$id' AND userStatus = 1 AND appointmentDate = CURRENT_DATE()";
                    ...
                    if (mysqli_num_rows($rxxx) > 0) {
                        ...
                        <?php }
                            ...
                            <tbody class="table-group-divider">
                                <?php
                                $sql = mysqli_query($connect, "select * from `appointment` where `employId` = '$id' AND userStatus = 1  AND appointmentDate = CURRENT_DATE() ");
