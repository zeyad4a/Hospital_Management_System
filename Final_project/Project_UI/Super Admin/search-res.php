                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./super-med record.php" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-1 py-2 text-sm font-medium">Medical
                                    Record</a>
                    ...
                    <table class=" table table-striped table-hover table-bordered border-gray-400">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <p class="text-lg leading- font-bold text-gray-900 text-center">appointment Date</p>
                                </th>
                                <th scope="col">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <?php
                            $search = $_POST['input'];
                            $ret = mysqli_query($connect, "SELECT * FROM `appointment` join doctors on doctors.id=appointment.doctorId WHERE `patient_Name` LIKE '%$search%' OR `patient_Num` LIKE '%$search%' OR `userId` LIKE '%$search%' ORDER BY postingDate DESC");
                            if ($ret->num_rows > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">
                                            ...
                                            <p class="text-lg leading- font-bold text-gray-900 text-center"><button class=" text-lg inline-flex items-center rounded-md bg-green-50 px-2 py-1 font-medium text-blue-700 ring-1 ring-inset ring-blue-600">
                                                    <?php if (($row['userStatus'] == 1) || ($row['userStatus'] == 2) && ($row['doctorStatus'] == 1)) {
                                                        echo "Active";
                                                    }
