                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./super-med record.php" class="bg-gray-900 text-white rounded-md px-1 py-2 text-sm font-medium" aria-current="page">Medical Record</a>
                ...
                <table class=" w-full table table-striped table-hover table-bordered border-gray-400">
                    <thead>
                        <tr>
                            ...
                            <th hidden scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Appointment ID</p>
                            </th>
                            <th scope="col">
                            ...
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Sign Date</p>
                            </th>
                            <th scope="col">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <?php
                        $sql = mysqli_query($connect, "select * from appointment where userStatus in (1,2) ORDER BY postingDate DESC ");
