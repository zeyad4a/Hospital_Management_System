            ...
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <table class=" table table-striped table-hover table-bordered border-gray-400">
                    ...
                    <tbody class="table-group-divider">
                        <?php
                        $sql = mysqli_query($connect, "select * from appointment join doctors on doctors.id=appointment.doctorId join users on users.uid=appointment.userId where appointmentDate = CURRENT_DATE() ORDER BY postingDate DESC ");
