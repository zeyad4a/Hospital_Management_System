                        ...
                        <tbody class="table-group-divider">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <th scope="col">
                                            <p class="text-lg leading- font-bold text-gray-900 text-center"><button class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-blue-700 ring-1 ring-inset ring-blue-300/20">
                                        ...
                                        <th scope="col">
                                        <p class="text-lg leading- font-bold text-gray-900 text-center"><a href="./report.php?id=<?php echo $row['apid'];?>&uid=<?php echo $userid;?>" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-green-700 ring-1 ring-inset ring-green-600/20">View</a></p>
                                        </th>
                                    </tr>
                        </tbody>
                <?php }
