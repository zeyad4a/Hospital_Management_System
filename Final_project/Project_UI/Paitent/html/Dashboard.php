          ...
          <div class="bg-white">
            <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
              <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                ...
                <?php
                $result = $connect->query(" SELECT COUNT(*) FROM appointment where userId = ' $uid ' AND appointmentDate = CURRENT_DATE()");
                ?>
                ...
                <?php
                $result2 = $connect->query("SELECT COUNT(*) FROM appointment where userId = ' $uid ' AND  userStatus = 1 AND appointmentDate = CURRENT_DATE() "); ?>
                ...
                <?php
                $result3 = $connect->query("SELECT COUNT(*) FROM appointment where userId = ' $uid ' AND  userStatus = 0 AND appointmentDate = CURRENT_DATE() "); ?>
                <div class="group relative">
                ...
                <?php
                $result5 = $connect->query("SELECT COUNT(*) FROM appointment where  userId = ' $uid ' AND  doctorStatus = 2 AND userStatus =2 AND appointmentDate = CURRENT_DATE() "); ?>
                <div class="group relative">
                ...
                <?php
                $sqlp = "SELECT SUM(consultancyFees) AS total FROM appointment WHERE  userId = ' $uid ' AND  appointmentDate = CURRENT_DATE()";
                ...
                <?php
                $result0 = $connect->query("SELECT COUNT(*) FROM appointment WHERE  userId = ' $uid ' ");
                ?>
                <div class="group relative">
                  <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-90 lg:h-48 ">
