          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="./Medical-Record.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Medical-Record</a>
              ...
              <th scope="col">
                <p class="text-lg leading- font-bold text-gray-900 text-center">Report</p>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <?php
                        $sql = mysqli_query($connect, "select doctors.doctorName as docname,appointment.*  from appointment join doctors on doctors.id=appointment.doctorId where appointment.userId='" . $_SESSION['uid'] . "'  ORDER BY postingDate DESC");
                  ...
                  <th hidden scope="col">
                    <p class="text-lg leading- font-bold text-gray-900 text-center"><?php echo $row['apid'] ?></p>
                  </th>
                  <th scope="col">
                  ...
                  <th scope="col">
                    ...
                    <p class="text-lg leading- font-bold text-gray-900 text-center"><button class=" text-lg inline-flex items-center rounded-md bg-green-50 px-2 py-1 font-medium text-blue-700 ring-1 ring-inset ring-blue-600"><?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) {
                                ...
                                <th scope="col">
                                    <form method="get">
                                        <p class="text-lg leading- font-bold text-gray-900 text-center"><a href="./report.php?id=<?php echo $row['apid'];?>&uid=<?php echo $row['userId'];?>" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-green-700 ring-1 ring-inset ring-green-600/20">View</a></p>
                                    </form>
                                </th>
                            </tr>
                    </tbody>
...
<!-- 
            ...
            <li class="flex justify-between gap-x-2 py-3">
                <div class="flex min-w-0 gap-x-4">
                  <div class="min-w-0 flex-auto">
                    <p class="text-lg leading- font-bold text-gray-900 translate-y-2">dr name</p>
                  </div>
                </div>
                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-center">
                  <p class="text-lg leading- font-bold text-gray-900 translate-y-2">scan</p>
                </div>
                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-center">
                  <p class="text-lg leading- font-bold text-gray-900 translate-y-2">date</p>
                </div>
                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-center">
                    <button type="button" class="btn btn-outline-warning">Waiting</button>
                </div>
                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-center">
